...
<html>
<head>
       <title>Virtual Tours - VirtualShrine</title>
...
<main class="main-content-visit container">
        ...
        <div class="tips color-primary-400 padding-block-500 fs-650">
        <ul>
                <li>To navigate between galleries in the tours, click on the click the drop down <br> menu.</li>
        ...
        <div class="note color-primary-400 fs-650">
              <b class="fw-bold"> Note: </b> this tour and these presentations have been thoroughly tested and should function on all commonly used devices and  browsers (using a desktop computer with Windows, Mac, Linux or a mobile device such as an iPhone, iPad, or Android). Its functionality and design may change as it adjusts automatically to accommodate the greatest number of visitors.
        </div>
    </div>
        </main>
