			...
			<option disabled>Select Building</option>
                 ...
                 <div class="col-md-4 col-12">
                  ...
                  <div class="col-md-4 col-12">
                    <div class="form-group">
                      ...
                      <input type="number" min="1" max="50" class="form-control" name="no_visitors" data-parsley-required="" data-parsley-required-message="Please select valid number of pax">
                      </input>
                    </div>   
                  </div>  
              </div>  
              ...
              -->
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <input type="file" name="id_image" class="form-control" accept=".jpg,.png,.gif,.webp" required="true" data-parsley-required-message="Attach ID is required"/>
                  </div>
