...
<div class="container">
      ...
      <div class="row" style="padding-left: 80px">
        <div class="col-md-12 offset-md-2 card pt-4 pb-4 pl-4 pr-4 mt-2">
          <form>
          <h5>&nbsp;</h5>
              <input type="hidden" class="form-check-input" id="consent">
              <p style="padding-left: 210px; padding-right: 210px;" class="form-check-label font-italic text-center" for="exampleCheck1">
        ...
        Thank you! Your booking has been cancelled.</p>
