                ...
                <div class="row">   
                  <div style="margin-left: 130px" class="col-md-8 col-12">             
                    <div class="form-group">
                      ...
                      <input type="text" name="booking_id" value="<?php if(isset($_GET['bookingID'])){echo $_GET['bookingID'];} ?>" class="form-control input-md" aria-required="true" aria-invalid="false" placeholder="Booking ID" autocomplete="off" data-parsley-required="" data-parsley-required-message="Booking ID is required">
                    </div>
                  </div>
