...
<header class="Gallery-header">
        ...
        <div class="Gallery-text">Galleries</div>         
</header>
<main class="main-content-plan">
<div class="plan-flex">
<div class="left-content">
<div class="gen-text">Explore the 5 galleries at the Casa Real Shrine <br> Museum from home.</div>
...
<img class="icon-casareal" src="Images/Logo.png">
</div>
