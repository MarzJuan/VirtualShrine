...
<html>
<head>
       <title>Plan Your Visit - VirtualShrine</title>
...
<body>
    <header class="primary-header plan-header">
    <div class="container">
...
<section class="guideLine-section">
        ...
        <div class="visitor-guideline-text2 fs-650 padding-block-700">Face covering are required for all visitors age 2 and older, even if you are vaccinated.</div>
        ...
        <main class="main-content-plan">
                ...
                <div class="free-text fs-700 fw-semi-bold color-primary-400">FREE ENTRY</div>
                <hr class="plan-line-right">
