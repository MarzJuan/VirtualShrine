...
<link rel="stylesheet" href="assets/css/gallery/gallerystyle.css">
...
<header class="plan-header">
        ...
        <div class="Plan-text">Plan your visit</div>       
        <button class="book-btn">Book now</button>  
</header>
<section class="guideLine-section">
<div class="guideline-flex">
<div class="visitor-guideline-text">Visitor GuideLines</div>
<div class="guide-cloumn2">
<span class="visitor-guideline-text2">Face covering are required for all visitors age 2 and older, even if <br> you are vaccinated.</span>
<div class="Read-Guideline-link"><a href="#">Read Visitor Guidelines</a></div>
</div>
</div>
</section>
...
<div class="gen-text">General Admission</div>
<div class="Admission-text">Admission is <strong>FREE.</strong> Ticket is not required.</div>
<div class="gen-sub-text">You are advised to book a scheduled slot in advance to
    guarantee entry and help control the number of individuals 
    who can visit. Walk-in visits are available each day for those  
    who arrive at the Museum without booking in advance. But  
    walk-in entry cannot be guaranteed because catering  
    number of visitors depends on the capacity. Please speak to   
    a staff upon your arrival to inquire about availability.</div>
<hr class="plan-line">
<div class="gen-text"> Health and Safety <br> Guidelines</div>
<div class="gen-sub-text">The safety of our staffs and visitors are at the top of our priority.
    ...
    Tourism (DOT) for increased health and safety procedures.</div>
</div>
<div class="right-content">
<div class="Free-text">
<div class="gen-textfree">FREE ENTRY</div>
<hr class="plan-line2">
...
<div class="right-subtext">See: <strong>Opening hours</strong></div>
<svg class="inline-icon" style="width:53px;height:53px" viewBox="0 0 24 24">
    ...
    <div class="right-title-text">
        ...
        <div class="right-subtext">See: <strong>Booking Information</strong></div>
        ...
        <svg class="inline-icon" style="width:53px;height:53px" viewBox="0 0 24 24">
            ...
            <div class="right-subtext">See: <strong>Getting here</strong></div>
...
<div><svg  class="fb" style="width:24px;height:24px" viewBox="0 0 24 24">
