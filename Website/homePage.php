...
<header class="main-header">
       ...
       <div class="Entry">Free Entry <hr class="line"></div>
       <div class="Operation">Operation time : 8:00 AM - 4:00PM</div>
       <div class="Welcome">WELCOME TO THE <br> VIRTUALSHRINE</div>       
...
<div class="section1-title">WHAT TO SEE</div>
<div class="horzontal-slider">
...
<div class="section2-title">VIRTUALSHRINE NEXT TO YOU</div>
<div class="section2-grid">
<div class="section2-image1">
       <div><button class="section2-btn">Videos</button></div>
       <div  class="section2-text">Narrated Tours</div>
</div>
<div class="section2-image2">
       <div><button class="section2-btn">Audio</button></div>
       <div class="section2-text">Audio Guide</div>
</div>
<div class="section2-image3">
       <div><button class="section2-btn1">Virtual Tours</button></div>
       <div class="section2-text">Rooms and Galleries</div>
</div>
<div class="section2-image4">
       <div><button class="section2-btn2">Virtual Collection</button></div>
       <div class="section2-text">Collection</div>
</div>
</div>
</section>
...
<div class="bg-color">
<div class="section3-text1">We need your support</div>
<div class="section3-text2">Share your thoughts about the VirtualShrine!</div>
<form>
       <textarea placeholder="Write here..." rows="7" cols="82" required>
       </textarea>
