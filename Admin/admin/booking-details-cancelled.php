        ...
        <?php include('message.php'); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Booking Details
                        <a href="booking-cancelled.php?id=<?= $_SESSION['auth_user']['user_id'];?>" class="btn btn-primary float-end">Back</a>
                    </h4>
                </div>
                <div class="card-body">
                            ...
                            <?php
                                ...
                                if($row['status'] == 0 || $row['status'] == 3)
                                {
                                    ...
                                    <?php
                                                ...
                                                if($row['status'] ==4)
                                                {
                                                    echo '<b style="margin-left:50px;">Status:</b><span style="color:BLUE;text-align:center;margin-left:50px;">Cancelled</span>';
                                                }
                                            }
