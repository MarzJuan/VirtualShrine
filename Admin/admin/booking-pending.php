...
<h4 class="mt-4">Pending Booking</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="code.php" method="POST">
                                                ...
                                                <button type="button" data-toggle="modal" data-target="#rejectBooking<?=$bookings['booking_id']?>" class="btn btn-danger">Reject</button>
                                            </form>
                                        </td>
 ...
 <div class="modal fade"
        id="rejectBooking<?=$bookings['booking_id']?>"
        tabindex="-1"
        role="dialog"
